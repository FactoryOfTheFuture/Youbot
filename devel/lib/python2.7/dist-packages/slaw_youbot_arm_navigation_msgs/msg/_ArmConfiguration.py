...
"""autogenerated by genpy from slaw_youbot_arm_navigation_msgs/ArmConfiguration.msg. Do not edit."""
import sys
...
class ArmConfiguration(genpy.Message):
  _md5sum = "4002ce9c0c27afe7b7ffe45719b55098"
  _type = "slaw_youbot_arm_navigation_msgs/ArmConfiguration"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """float32 arm_joint_1
float32 arm_joint_2
float32 arm_joint_3
float32 arm_joint_4
float32 arm_joint_5"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ArmConfiguration, self).__init__(*args, **kwds)
