...
"""autogenerated by genpy from slaw_youbot_arm_navigation_actions/VelocityControlledJointTrajectoryAction.msg. Do not edit."""
import sys
...
class VelocityControlledJointTrajectoryAction(genpy.Message):
  _md5sum = "62ea273e7cc37b2849ea51993b4dd0d7"
  _type = "slaw_youbot_arm_navigation_actions/VelocityControlledJointTrajectoryAction"
...
"""
  ...
  _slot_types = ['slaw_youbot_arm_navigation_actions/VelocityControlledJointTrajectoryActionGoal','slaw_youbot_arm_navigation_actions/VelocityControlledJointTrajectoryActionResult','slaw_youbot_arm_navigation_actions/VelocityControlledJointTrajectoryActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(VelocityControlledJointTrajectoryAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = slaw_youbot_arm_navigation_actions.msg.VelocityControlledJointTrajectoryActionGoal()
      if self.action_result is None:
        self.action_result = slaw_youbot_arm_navigation_actions.msg.VelocityControlledJointTrajectoryActionResult()
      if self.action_feedback is None:
        self.action_feedback = slaw_youbot_arm_navigation_actions.msg.VelocityControlledJointTrajectoryActionFeedback()
    else:
      self.action_goal = slaw_youbot_arm_navigation_actions.msg.VelocityControlledJointTrajectoryActionGoal()
      self.action_result = slaw_youbot_arm_navigation_actions.msg.VelocityControlledJointTrajectoryActionResult()
      self.action_feedback = slaw_youbot_arm_navigation_actions.msg.VelocityControlledJointTrajectoryActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_goal.goal.configurations)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.configurations:
        _x = val1
        buff.write(_struct_5f.pack(_x.arm_joint_1, _x.arm_joint_2, _x.arm_joint_3, _x.arm_joint_4, _x.arm_joint_5))
      _x = self
      buff.write(_struct_f3I.pack(_x.action_goal.goal.max_speed, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.configurations = []
      for i in range(0, length):
        ...
        self.action_goal.goal.configurations.append(val1)
      _x = self
      start = end
      end += 16
      (_x.action_goal.goal.max_speed, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_f3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
